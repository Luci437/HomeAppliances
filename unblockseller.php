...
<body>
   <div >
    ...
    <div style="margin-left: 400px;max-width: 200px;margin-top:200px;">
       <?php
//$qry="select * from login,role where login.role_id=role.role_id";
      $qry="select * from seller where status=0";
...
$sql5="UPDATE `seller` SET `status`='1' WHERE `userid`='$l'";
$result5=mysqli_query($con,$sql5) or die("error");
$sql3="UPDATE `login` SET `status`='1' WHERE `userid`='$l'";
$result3=mysqli_query($con,$sql3) or die("error");
echo "<script> alert('delete successfull');</script>";
header("location:unblockseller.php");
}
?>
<table >
  <tr>
