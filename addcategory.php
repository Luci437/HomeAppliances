...
$sql4="select * from category where category_name='$categoryname'";
...
<input type="text" class="input-box" name="category-name">
<input type="submit" name="add-category" value="Add" class="submit-button" placeholder="Country name here">
</form>
...
<div class="available-countries">
    <?php
          ...
          while($row = mysqli_fetch_assoc($result)) {
            echo '<h5>'.$row["category_name"].' <a href="delete-category.php?cid='.$row["category_id"].'" class="delete-button">X</a></h5>';
          }
          ?>
</div>
