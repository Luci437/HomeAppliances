...
<ul>
			...
			<section class="main-content">	
				...
				<div class="row">
					<div class="span12">					
						 ...
						 <h3 style="color:#FF0000"> &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp;  &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp;Return Items</h3>
						 <?php
		  ...
		  ?>
					...
					<thead>
						<tr>
							...
							<td><b style="font-size:14px">Actions</b></td>
		  ...
		  ?>
						<tr>
                            ...
                            $status = $rowd['status'];
                            if($status == 'Lend') {
                                echo '<td><a href="requestReturn.php?receptId='.$receptId.'">Send_Return</a></td>';
							}elseif($status == 'Collected') {
								echo '<td><a style="color: green;">Collected</a></td>';
							}
							else {
                                echo '<td><a style="color: yellow;">Request_Sended</a></td>';
                            }
