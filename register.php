...
$row=mysqli_fetch_array($result2);
 ...
 $sql="INSERT INTO `seller`(`userid`,`first_name`, `last_name`, `store_name`, `mobile_number`, `email`,`place_id`, `gst_no`, `username`, `password`,`lat`,`lon`, `status`) VALUES ($l,'$a','$b','$c','$d','$e','$j','$f','$k','$p','$lat','$lon',1)";
