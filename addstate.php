...
if (isset($_POST['add-state'])) {
    ...
    $subcategoryname = $_POST['state-name'];
    $category_select = $_POST['country-name'];

    
    
  
    $sql4="select * from state where state_name='$subcategoryname'";
...
<body>
    ...
    <div class="sub-box">
        ...
        <form method="post" action="" style="text-align: center;">
            <select class="input-box" name="country-name" id="category_select">
            ...
            <input type="text" class="input-box" name="state-name">
            <input type="submit" name="add-state" value="Add" class="submit-button" placeholder="Country name here">
        </form>
        ...
        <div class="available-countries">
          ...
          while($row = mysqli_fetch_assoc($result)) {
            echo '<h5>'.$row["state_name"].' <a href="delete-state.php?sid='.$row["state_id"].'" class="delete-button">X</a></h5>';
          }
          ?>
        </div>
